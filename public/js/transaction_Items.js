...
$(document).ready(function(){
    ...
    $("#transSearch").keyup(function(){
        ...
        if(value){
            $.ajax({
                url: appRoot+"search/trans_Itemsearch",
                type: "get",
                data: {v:value},
    ...
    //calcuate cumulative amount if the Amount Tendered is changed
    $("#amountTendered").change(ceipacp);
    ...
    $("#confirmSaleOrder").click(function(){
        ...
        if(isNaN(amountTendered) || (amountTendered === '0.00') || !modeOfPayment || (amountTendered < cumAmount) || !phonePattern.test(custPhone)){
            ...
            return new Promise(function(resolve, reject){
                ...
                $.ajax({
                    url: appRoot+"transaction_Items/nso_",
                    method: "post",
                    ...
                    success:function(returnedData){
                        if(returnedData.status === 1){
                            ...
                            //display receipt
                            $("#trans_ItemReceipt").html(returnedData.transReceipt);//paste receipt
                            $("#trans_ItemReceiptModal").modal('show');//show modal
...
function gti_(transId){
    if(transId){
        ...
        $.ajax({
            type: "POST",
            url: appRoot+"transaction_Items/transactionReceipt",
...
function ceipacp(){
    ...
    $(".transItemList").each(function(){
        ...
        if(transQty > availQty){
            ...
            $(this).find("#cumAmount").html(cumulativePrice);
...
function latr_(url){
    ...
    $.ajax({
        type:'get',
        url: url ? url : appRoot+"transaction_Items/latr_/",
