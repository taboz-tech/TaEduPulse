            ...
            <table class="table table-bordered table-striped table-hover" style="background-color: #f5f5f5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $totalSold = $this->genmod->gettablecol('transactions_item', 'SUM(quantity)', 'itemCode', $get->code);
                        ...
                        <td>
                            <?php
                            $totalPrice = $this->genmod->gettablecol('transactions_item', 'SUM(totalPrice)', 'itemCode', $get->code);
                            if ($totalPrice !== null) {
