    ...
    public function add(){
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $insertedId = $this->teacher->add(set_value('teacherName'), set_value('teacherSurname'), set_value('teacherGender'), 
                    set_value('teacherSubject'), set_value('teacherPhone'),set_value('teacherAddress'),set_value('teacherDepartment'));
            ...
            $desc = "Addition of {$teacherName} {$teacherSurname} as a new Teacher with  Address '{$teacherAddress}' and Subject '{$teacherSubject}'to the Teachers.";
    ...
    */
    ...
    public function edit(){
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $updated = $this->teacher->edit($teacherId, $teacherName, $teacherSurname, $teacherPhone,$teacherAddress,$teacherSubject,$teacherDepartment);
